// Importing China (or any country) administrative boundaries

var worldcountries = ee.FeatureCollection('USDOS/LSIB_SIMPLE/2017');
var filterCountry = ee.Filter.eq('country_na', 'China');
var country = worldcountries.filter(filterCountry);

Map.addLayer(country);
Map.centerObject(country, 6);

// Importing air pollution values 

var no2ic = ee.ImageCollection("COPERNICUS/S5P/OFFL/L3_CO").select('CO_column_number_density');

// Filtering and averaging air pollution values
